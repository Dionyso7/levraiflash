  ...
  },
  {
    ...
    variants: [
      ...
      },
      {
        ...
        name: 'Bouteille couchee art de vivre',
        promptAddon: 'Bouteille couchee, photo prise du dessus, flat lay charge et premium avec plusieurs verres.',
        promptOverride: 'The exact same product as in the reference image, with identical shape, identical proportions, identical colors, identical materials, identical visible details and overall presentation fully preserved - do not alter or hallucinate any part of the product. Restage the product in a premium overhead art de vivre composition, photographed clearly from above in an editorial flat-lay scene. Keep the original product form exactly as shown in the reference image: do not convert it into a bottle, jar, sauce container, condiment container, or any other packaged format. Build a richer Pinterest-editorial arrangement around it with coherent premium elements distributed across the surface: multiple glasses, fruit cuts, garnishes, textiles, ceramics, coasters, serving tools, trays, leisure details or artisanal objects that genuinely match the product universe. Only the referenced product may appear as the hero: do not include any substitute hero object, any extra packaged product, or any other product of the same category anywhere in the composition. Match the visual proportions of the references: the product is prominent and readable but not oversized, usually occupying about one quarter to one third of the frame, while the surrounding decor fills the rest of the composition in a controlled but abundant way. The styling should feel sunlit, summery, tactile and desirable, with several objects partially cropped by the frame edges so the image feels like a real captured moment instead of a centered catalog shot. Use warm direct sunlight, crisp graphic shadows, premium textures, and a clearly top-down point of view across the whole scene, photorealistic.',
        negativePrompt: 'invented bottle, sauce bottle, condiment bottle, jar, substituted packaging, wrong product format, product transformed into bottle, product transformed into packaged container, substitute hero object, extra packaged product, another product of the same type, eye-level shot, frontal shot, perspective side view, isolated packshot, empty scene, cheap party props, supermarket styling, plastic clutter, face, full person, crowd, altered design, invented text, blurry glasses, irrelevant objects, sterile corporate studio, sparse decor, flat generic styling',
        aspectRatio: '4:5',
        enabledByDefault: true,
        sourceMode: 'master',
      },
